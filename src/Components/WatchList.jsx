...
className={currGenre==genre?'flex mx-4 justify-center items-center h-[3rem] w-[9rem] rounded-xl text-white font-bold bg-blue-400 mx-4':
    'flex mx-4 justify-center items-center h-[3rem] w-[9rem] rounded-xl text-white font-bold bg-gray-400/50'}>
    {genre}
    </div>
})}
</div>
...
{watchlist.filter((movieObj)=>{
  ...
  <td className='flex items-center px-6 py-4'>
    <img className="h-[10rem] w-[10rem] "src={`https://image.tmdb.org/t/p/original/${movieObj.poster_path}`}/>
